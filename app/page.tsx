      ...
      <section className="bg-emerald-600 text-white py-6">
        <div className="container mx-auto px-4 text-center">
          <p className="text-lg mb-2">
            ¿Necesitás ayuda para planificar tu visita?
          </p>
          <a
            href="https://wa.me/5493624000000?text=Hola!%20Necesito%20información%20sobre%20La%20Escondida"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center bg-white text-emerald-600 px-6 py-3 rounded-full font-semibold hover:bg-emerald-50 transition"
          >
            <svg
